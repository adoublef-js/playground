    ...
    class n {
        ...
        static tokenize(e, t) {
            ...
            function w() {
                ...
                if (S() !== t) {
                    throw Error(
                        "Unterminated string at " + n.positionString(e)
                    );
                } else {
                    C();
                }
    ...
    class i {
        ...
        requireTokenType(e, t, r, n) {
            ...
            if (i) {
                ...
                this.raiseError(
                    this,
                    "Expected one of " + JSON.stringify([e, t, r])
                );
            }
        }
    ...
    class a {
        constructor(e) {
            ...
            this.addGrammarElement("primaryExpression", function (e, t, r) {
                ...
                e.raiseParseError(
                    r,
                    "Unexpected value: " + r.currentToken().value
                );
            });
        }
        use(e) {
                ...
                var i = {
                    ...
                    print: function (e) {
                        ...
                        for (var n = 0; n < r.length; n++) {
                            t = Math.max(
                                t,
                                r[n].meta.feature.displayName.length
                            );
                        }
                        for (var n = 0; n < r.length; n++) {
                            var i = r[n];
        ...
        class r extends m {
            ...
            [Symbol.iterator]() {
                ...
                this.elements.forEach((e) =>
                    e.removeAttribute("data-hs-query-id")
                );
                return e;
            }
        }
                ...
                return {
                    ...
                    op: function (e, r) {
                        ...
                        if (n) {
                            ...
                            throw new Error(
                                "Typecheck failed!  Expected: " + s.value
                            );
                        }
                    },
                    evaluate: function (e) {
                    ...
                    for (const r of L.events) {
                        ...
                        t.implicitLoop(n, function (n) {
                            ...
                            if (r.intersectionSpec) {
                                ...
                                const e = new IntersectionObserver(function (
                                    r
                                ) {
                                    for (const o of r) {
                                        var a = { observer: e };
        ...
        t.addGrammarElement("dotOrColonPath", function (e, t, r) {
            ...
            if (n) {
                ...
                if (a) {
                    do {
                        i.push(
                            r.requireTokenType("IDENTIFIER", "NUMBER").value
                        );
        ...
        t.addCommand("pick", (e, t, r) => {
            ...
            if (r.matchToken("matches")) {
                ...
                if (r.matchOpToken("|")) {
                    i =
                        "g" +
                        r.requireToken("identifier").value.replace("g", "");
                }
                console.log("flags", i);
                r.requireToken("from");
                const a = e.parseElement("expression", r);
