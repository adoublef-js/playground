        ...
        socketWrapper.addEventListener("message", function (event) {
            ...
            if (fragment.children.length) {
                ...
                for (var i = 0; i < children.length; i++) {
                    api.oobSwap(
                        api.getAttributeValue(children[i], "hx-swap-oob") ||
                            "true",
                        children[i],
                        settleInfo
                    );
            ...
            init: function () {
                ...
                socket.onclose = function (e) {
                    ...
                    if (
                        ...
                        var delay = getWebSocketReconnectDelay(
                            wrapper.retryCount
                        );
                        setTimeout(function () {
    ...
    function processWebSocketSend(socketElt, sendElt) {
        ...
        triggerSpecs.forEach(function (ts) {
            api.addTriggerHandler(sendElt, ts, nodeData, function (elt, evt) {
                ...
                var allParameters = api.mergeObjects(
                    rawParameters,
                    expressionVars
                );
                var filteredParameters = api.filterValues(
                    allParameters,
                    sendElt
                );
